...
class Result:
    ...
    def gather_print_information(self, student_name: str)-> dict:
        """ Gathers Information that will be used to print a Receipt
        Args:
        student_name:str
        returns:
        dict
        ...
        """ Einfügen der nichts zu errechnenden Werte"""
        ...
        if grading_scheme == "sek1":
            mark_1_points=round(0.95*(self.get_exam()).max_points)
            mark_2_points=round(0.8*(self.get_exam()).max_points)
            mark_3_points=round(0.6*(self.get_exam()).max_points)
            mark_4_points=round(0.4*(self.get_exam()).max_points)
            mark_5_points=round(0.8*(self.get_exam()).max_points)
