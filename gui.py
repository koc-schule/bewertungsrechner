...
def confirm_input(): # Startet show_evaluation_table
...
def show_evaluation_table(course, exam): # Erstellt die Tabelle zur Eingabe der Bewertung
...
def confirm_evaluation():  # Erstellt ein Objekt der Klasse Result aus den Eingaben
